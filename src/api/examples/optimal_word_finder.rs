use pathfinder::game::{GameEngine, Board};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let words = vec![
        ...
        "end", "den", "pen", "get", "gem", "leg", "let", "met", "map", "tap", "pat",
        "sat", "rat", "tar", "art", "car", "arc", "cap", "can", "man", "pan", "tan",
        "eat", "tea", "ate", "eta", "ace", "age", "ago", "ego", "log", "cog", "god", "nod",
        "don", "con", "cod", "dot", "got", "hot", "hop", "top", "pot", "rot",
        "lot", "not", "oat", "oak", "ask", "ark", "air", "are", "ear", "era", "ore",
        "roe", "row", "sow", "sew", "new", "now", "own", "won", "one", "eon", "ion", "son",
        "sun", "run", "gun", "gum", "rum", "sum", "sim", "sin", "tin", "win", "wit",
        "bit", "bat", "bag", "big", "dig", "fig", "fag", "far", "bar", "bad", "dad", "sad",
        "mad", "had", "has", "his", "hit", "kit", "lit", "pit", "sit", "fit", "fat", "hat",
        "hag", "lag", "tag", "gag", "gap", "gas", "was", "saw", "paw", "raw", "ram",
        "jam", "ham", "dam", "damp", "clamp", "stamp", "tramp", "cramp"
    ];
    ...
    println!("Successfully found {} words with total score: {}", 
